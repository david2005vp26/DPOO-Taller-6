...
public class VentanaPrincipal extends JFrame
{
    ...
    public void mostrarVentanaMapa( )
    {
        ...
        {
            ventanaMapa = new VentanaMapa(this, this.mundo.getRestaurantes(true) );
    ...
    private void actualizarRestaurantes(){
        ...
        // Actualiza el panel de lista con los nuevos datos
        pLista.actualizarRestaurantes(todos);
        
        // Si hay restaurantes, selecciona el primero de la lista por defecto
        if (!todos.isEmpty())
        {
